function aylantir() {
  ...
  document.querySelector(".img1").src = `assets/dice${tasodifiy1}.png`;
  document.querySelector(".img2").src = `assets/dice${tasodifiy2}.png`;
  if (tasodifiy1 > tasodifiy2) {
    document.getElementById("winner").innerHTML = "Birinchi oyinchi g`olib";
  } else if (tasodifiy2 > tasodifiy1) {
    document.getElementById("winner").innerHTML = "ikkinchi oyinchi g`olib";
  } else {
